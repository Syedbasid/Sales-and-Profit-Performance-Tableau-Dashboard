...
- Excel / CSV
- Data Visualization
- Calculated Fields & KPI Analysis

## Data Preparation
- Loaded raw sales data into Tableau
- Formatted date fields and handled missing values
- Created calculated fields for:
  - Profit = Sales − (Order Quantity × Product Price)
...
## Dashboard Features
- Interactive sales and profit trend analysis
- KPI indicators for Total Sales, Total Profit, and Average Profit Margin
- Filters for Region, Customer Segment, Category, and Date
